...
; Generated by Jari Saukkonen on 06/11/2018 (UTC)
;
[Setup]
AppID={{e09a8cb4-f961-4489-a675-652b899b6d57}
...
OutputDir="."
OutputBaseFilename="KomaHub ASCOM ObservingConditions Setup"
Compression=lzma
...
[Files]
Source: "C:\Users\Jari Saukkonen\source\repos\komahub\software\ASCOMObservingConditions\bin\Release\ASCOM.KomaHub.ObservingConditions.dll"; DestDir: "{app}"
Source: "C:\Users\Jari Saukkonen\source\repos\komahub\software\ASCOMObservingConditions\bin\Release\NewtonSoft.Json.dll"; DestDir: "{app}"

; Only if driver is .NET
[Run]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.KomaHub.ObservingConditions.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.KomaHub.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.KomaHub.ObservingConditions.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.KomaHub.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.KomaHub.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
